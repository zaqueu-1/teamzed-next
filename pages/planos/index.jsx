    ...
    <>
        ...
        <div className='plans-container'>
            <div className="plans-info">
                <Image className='teamzed-logo' src='/src/images/teamzed-logo.png' width='600' height='200' />
                <h3>De forma prática, é possível começar agora mesmo, através de uma videochamada ou formulário enviado diretamente pra você pelo WhatsApp. A consultoria inclui:</h3>
                <ul>
                ...
                <a className='join-btn' href="https://wa.me/5521989122887"><BsFillCheckSquareFill className='join-icon' />Quero entrar pro time!</a>
            </div>
